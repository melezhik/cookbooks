...
* `from_cookbook` - specifies cookbook, where distributive stored at. Check out [cookbook_file resource documentation](http://wiki.opscode.com/display/chef/Resources#Resources-CookbookFile)
