define :psgi_application, :cookbook => 'psgi', :operator => 'Catalyst', :environment => {}, :plackup_environment => 'development', :perl5lib => [], :nproc => '1',  :debug => '1', :install_dir => '/etc/init.d/', :enable_service => '1', :ignore_failure => true do 
